...
@pytest.mark.parametrize("body, subject, expected_category",
        ...
        ("Мама, не работает код! Дай мне доступ к файлу, я поменяю его. Спасибо",
        ...
        ("Немедленно требую продлить мне отпуск, я устала!",
        "Отпуск Хан Диане",
        "hr"),

        ("Давайте созвонимся сегодня вечером, а то нам сдавать хакатон уже пора",
        "Встреча команды 14",
        "invitation"),
